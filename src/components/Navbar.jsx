          ...
          <Link to={'/'}>
            <div className="flex items-center space-x-3 cursor-pointer">
              ...
              <h1 className="text-4xl font-extrabold tracking-widest uppercase">
                Shreeyash<span className="text-orange-400">STORE</span>
              </h1>
            </div>
          </Link>
          <nav className="flex items-center space-x-6">
            <Link to={'/cart'} className="relative p-3 bg-orange-500/10 rounded-xl hover:bg-orange-500/20 transition duration-200 border-orange-400/50 shadow-lg cursor-pointer">
